...
const defaultCopyright = '<p><a target="_blank" href="https://kampus.ebyu.edu.tr">Erzincan Binali Yıldırım Üniversitesi</a>.</p>';
const defaultLogo = 'logo.png?v=1';
const defaultTerms = "terms.png?v=1";
// Playback events
var dataReady = false;
...
function loadLogo(logo) {
  ...
  logger.info("==Loaded logo from", logoURL);
    $("#slide").css('background-image', 'url(' + defaultTerms + ')'); // $("#slide").css('background-image', 'url(' + logoURL + ')');
